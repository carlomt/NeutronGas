...
G4Material* DetectorConstruction::DefineMixture(const G4double pressure, const G4double temperature)
{
  ...
  G4double density_CF4     = rho_CF4*0.7* pressure/STP_Pressure * STP_Temperature/temperature;
  G4double density_CHF3    = rho_CHF3*0.28* pressure/STP_Pressure * STP_Temperature/temperature;
  G4double density_C4H10   = rho_C4H10*0.02*pressure/STP_Pressure * STP_Temperature/temperature;  
